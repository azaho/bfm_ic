...
for gpu_id in {0..7}; do
    ...
    srun --gres=gpu:1 --cpus-per-task=8 --exclusive python ${filename_array[filename_index]} --dtype ${dtype_array[dtype_index]} --optimizer ${optimizer_array[optimizer_index]} \
