...
for gpu_id in {0..7}; do
    ...
    lr_index=$((index / 3 % 3))
    electrode_init_index=$((index / 9 % 2))
    ...
    --subjects ${subjects_array[subjects_index]} --wait_n_intervals $index --wandb_project bfm --rs $random_string --wandb_project bfm_clip1 --nl ${nl_array[nl_index]} &
done
