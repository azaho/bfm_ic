...
subject_id = 2
trial_id = 4
dataloader1 = BrainTreebankDataLoader(subject_id, trial_id, trim_electrodes_to=trim_electrodes_to, device=device)
subject_id = 1
trial_id = 1
dataloader2 = BrainTreebankDataLoader(subject_id, trial_id, trim_electrodes_to=trim_electrodes_to, device=device)
subject_id = 3
trial_id = 1
