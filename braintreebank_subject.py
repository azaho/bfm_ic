...
class Subject:
    ...
    def get_electrode_coordinates(self, laplacian_rereferenced=LAPLACIAN_REREFERENCED):
        """
        ...
        return coordinates
    def get_n_electrodes(self, laplacian_rereferenced=LAPLACIAN_REREFERENCED):
    ...
    def get_spectrogram(self, electrode_label, trial_id, window_from=None, window_to=None, 
                        normalizing_params=None, laplacian_rereferenced=LAPLACIAN_REREFERENCED, return_power=True, 
    ...
    def get_spectrogram_normalizing_params(self, electrode_label, trial_id, laplacian_rereferenced=LAPLACIAN_REREFERENCED, cache=True):
    ...
    def get_electrode_data_normalizing_params(self, electrode_label, trial_id, laplacian_rereferenced=LAPLACIAN_REREFERENCED, cache=True):
        if laplacian_rereferenced:
