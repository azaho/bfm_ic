...
for gpu_id in {0..7}; do
    ...
    --subjects ${subjects_array[subjects_index]} --wait_n_intervals $index --wandb_project bfm --rs ${random_string_array[random_string_index]} --wandb_project bfm_clip_bofa2_fixed2 --nl ${nl_array[nl_index]} &
done
